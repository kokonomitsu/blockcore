...
namespace Blockcore.Networks.Bigcoin
{
    public class BigcoinMain : Network
    {
        public BigcoinMain()
        {
            ...
            {
                [BigcoinBIP9Deployments.TestDummy] = new BIP9DeploymentsParameters("TestDummy", 28, 1199145601, 1230767999, BIP9DeploymentsParameters.DefaultMainnetThreshold),
                [BigcoinBIP9Deployments.CSV] = new BIP9DeploymentsParameters("CSV", 0, 1462060800, 1493596800, BIP9DeploymentsParameters.DefaultMainnetThreshold),
                [BigcoinBIP9Deployments.Segwit] = new BIP9DeploymentsParameters("Segwit", 1, 1479168000, 1510704000, BIP9DeploymentsParameters.DefaultMainnetThreshold)
            };
