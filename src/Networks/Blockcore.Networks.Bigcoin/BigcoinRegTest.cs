...
{
    public class BigcoinRegTest : BigcoinMain
    {
        public BigcoinRegTest()
        {
            this.Name = "RegTest";
            this.AdditionalNames = new List<string> { "reg" };
            this.NetworkType = NetworkType.Regtest;
            this.Magic = 0xDAB5BFFA;
            this.DefaultPort = 16444;
            ...
            {
                [BigcoinBIP9Deployments.TestDummy] = new BIP9DeploymentsParameters("TestDummy", 28, 0, 999999999, BIP9DeploymentsParameters.DefaultRegTestThreshold),
                [BigcoinBIP9Deployments.CSV] = new BIP9DeploymentsParameters("CSV", 0, 0, 999999999, BIP9DeploymentsParameters.DefaultRegTestThreshold),
                [BigcoinBIP9Deployments.Segwit] = new BIP9DeploymentsParameters("Segwit", 1, BIP9DeploymentsParameters.AlwaysActive, 999999999, BIP9DeploymentsParameters.AlwaysActive)
            };
