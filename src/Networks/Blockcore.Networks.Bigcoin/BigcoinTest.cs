...
namespace Blockcore.Networks.Bigcoin
{
    public class BigcoinTest : BigcoinMain
    {
        public BigcoinTest()
        {
            ...
            {
                [BigcoinBIP9Deployments.TestDummy] = new BIP9DeploymentsParameters("TestDummy", 28, 1199145601, 1230767999, BIP9DeploymentsParameters.DefaultTestnetThreshold),
                [BigcoinBIP9Deployments.CSV] = new BIP9DeploymentsParameters("CSV", 0, 1456790400, 1493596800, BIP9DeploymentsParameters.DefaultTestnetThreshold),
                [BigcoinBIP9Deployments.Segwit] = new BIP9DeploymentsParameters("Segwit", 1, 1462060800, 1493596800, BIP9DeploymentsParameters.DefaultTestnetThreshold)
            };
            ...
            {
                { 0, new CheckpointInfo(new uint256("0000000069922066d073e9646a13a6410655dd783e4d1d22d373cd8499b55044")) },
            ...
            Assert(this.Consensus.HashGenesisBlock == uint256.Parse("0x0000000069922066d073e9646a13a6410655dd783e4d1d22d373cd8499b55044"));
