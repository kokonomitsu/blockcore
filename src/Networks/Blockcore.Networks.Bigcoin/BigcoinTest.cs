    ...
    public class BigcoinTest : BigcoinMain
    {
        public BigcoinTest()
        {
            ...
            this.Consensus = new Consensus.Consensus(
                ...
                targetTimespan: TimeSpan.FromSeconds(7 * 24 * 60 * 60), // two weeks
