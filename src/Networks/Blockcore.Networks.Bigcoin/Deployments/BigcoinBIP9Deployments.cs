...
namespace Blockcore.Networks.Bigcoin.Deployments
{
    /// <summary>
    /// BIP9 deployments for the Bigcoin network.
    /// </summary>
    public class BigcoinBIP9Deployments : BIP9DeploymentsArray
    {
        ...
        /// </summary>
        public BigcoinBIP9Deployments() : base(NumberOfDeployments)
        {
        }
