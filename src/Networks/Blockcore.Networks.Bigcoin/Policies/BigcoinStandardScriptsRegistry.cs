...
namespace Blockcore.Networks.Bigcoin.Policies
{
    /// <summary>
    /// Bigcoin-specific standard transaction definitions.
    /// </summary>
    public class BigcoinStandardScriptsRegistry : StandardScriptsRegistry
    {
        // See MAX_OP_RETURN_RELAY in Bigcoin Core, <script/standard.h.>
