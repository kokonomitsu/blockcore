...
{
    /// <summary>
    /// Check that a <see cref="BigcoinMain" /> network block has the correct version according to the defined active deployments.
    /// </summary>
    public class BigcoinActivationRule : HeaderValidationConsensusRule
    {
        /// <inheritdoc />
